...
import Group152 from "../Assets/Group 152.png";
import Group153 from "../Assets/Group 153.png";

const WebChapter3Result3 = (props) => {
  ...
  return (
    <>
      ...
      <Chapter3ResultImageContainer>
        <Group153Image src={Group153} alt="Chapter 34 Group153" />
        <GradientOverlay />
      </Chapter3ResultImageContainer>
      <AgreeText>
        기권
      ...
      <Group152ResultImage src={Group152} alt="Chapter 34 Group152" />
    </>
  );
};
...
const Group153Image = styled.img`
  width: 948px;
  height: 263px;
  right: 250px;
  top: 250px;
...
const Group152ResultImage = styled.img`
  width: 47%;
...
export default WebChapter3Result3;